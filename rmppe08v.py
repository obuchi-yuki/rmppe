...
if __name__ == '__main__':
	...
	argvs = sys.argv
	if (len(sys.argv) != 3):
		print ('incorrect argument: Please select mp4 file and gpu(0-3)')
		sys.exit()
...
#	i = 0
	...
	#		fout.savefig(path2 + '/' + image_names[i])
			...
			entry['all_peaks_frame' + str(count) + '.jpg'] = apout
			entry['subset_frame' + str(count) + '.jpg'] = sout
			entry['candidate_frame' + str(count) + '.jpg'] = cout
